...
public class TechnologyAdapter extends RecyclerView.Adapter<TechnologyAdapter.TechnologyHolder> implements Filterable {
    List<Article> list;
    List<Article> filteredArticles;
    Context context;

    public TechnologyAdapter(List<Article> list, Context context) {
        this.list = list;
    ...
    @NotNull
    @Override
    public TechnologyHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        return new TechnologyHolder(LayoutInflater.from(parent.getContext())
        .inflate(R.layout.news_items,parent,false));
    }

    @Override
    public void onBindViewHolder(@NonNull @NotNull TechnologyHolder holder, int position) {
    ...
    class TechnologyHolder extends RecyclerView.ViewHolder {
        ...
        public TechnologyHolder(@NonNull @NotNull View itemView) {
            super(itemView);
